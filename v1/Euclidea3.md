...
- 9.1 最小周长 - 1 *6L 6E*  
解：[6L6E，由光走最短路原理，只要作出定点关于两边的对称点，然后连接即可。
//忘记定理公式情况下的解决步骤：
  1,作两角边上任意两动点MN与已知固定点P，求△PMN周长(=PM+MN+PN)最短时MN的位置；
  2,为方便计算△PMN周长，作P关于M的代替点==>以MP为半径作圆，圆上任意一点r与M相连得线段Mr=MP，可得PM+MN+NP=Mr+MN+NP；
  3，根据M是在直线OA上的动点，寻找r的特性==》M在OA上移动时，始终有固定点P1使得MP1=Mr=MP，P1为固定点P关于OA的垂直对称点(等腰三角形△PMP1底边的高MO1垂直平分底边PP1,PO1=P1O1），同理有固定点P2;
  4,现△PMN周长为PM+MN+NP=MP1+MN+NP2，点M，N可在OA,OB上任意移动，由两点之间直线最短，可得当P1,M,N,P2在一条直线上时MP1+MN+NP2最短，得出P1P2与OA,OB的交点m,n（∠O任意度数均适用）.](solving/9.1.png)  
